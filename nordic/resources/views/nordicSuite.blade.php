			...
			<div class="row">
				<div class="col-lg-12"><!-- Room Gallery Slider -->
					<div class="room-gallery">
						...
						<div class="flexslider-thumb falsenav">
							<ul class="slides">
								<li data-thumb="{{asset('assets/img/rooms/nordic_suite/room-1.jpg')}}"><img alt="Slider 1" class="img-responsive" src="{{asset('assets/img/rooms/nordic_suite/room-1.jpg')}}"/></li>
								<li data-thumb="{{asset('assets/img/rooms/nordic_suite/room-2.jpg')}}"><img alt="Slider 1" class="img-responsive" src="{{asset('assets/img/rooms/nordic_suite/room-2.jpg')}}"/></li>
								<li data-thumb="{{asset('assets/img/rooms/nordic_suite/room-3.jpg')}}"><img alt="Slider 1" class="img-responsive" src="{{asset('assets/img/rooms/nordic_suite/room-3.jpg')}}"/></li>
                                <li data-thumb="{{asset('assets/img/rooms/nordic_suite/room-4.jpg')}}"><img alt="Slider 1" class="img-responsive" src="{{asset('assets/img/rooms/nordic_suite/room-4.jpg')}}"/></li>
								<li data-thumb="{{asset('assets/img/rooms/nordic_suite/room-5.jpg')}}"><img alt="Slider 1" class="img-responsive" src="{{asset('assets/img/rooms/nordic_suite/room-5.jpg')}}"/></li>
								<li data-thumb="{{asset('assets/img/rooms/nordic_suite/room-6.jpg')}}"><img alt="Slider 1" class="img-responsive" src="{{asset('assets/img/rooms/nordic_suite/room-6.jpg')}}"/></li>
							</ul>
						</div>
					</div>
				</div>
				<div class="col-lg-9 clearfix"><!-- Room Information -->
					<div class="col-lg-8 clearfix col-sm-8">
						...
						<p class="margint30">Our Nordic Suites are spaciously sized with a king size bed, a large sitting area, a writing desk. The Suite is furnished to suit your need, its also perfect as an office while staying with us.</p>
					...
					<div class="col-lg-4 clearfix col-sm-4">
						<div class="room-services"><!-- Room Services -->
							...
							<ul class="room-services">
								<li><i class="fa fa-check-circle fa-lg"></i> ROOM SIZE (770m x 530m) </li>
						...
						<div class="quick-reservation clearfix">
							<div class="title-quick pos-center margint30">
                                ...
                                <div style="padding-top:30px;" >
									<p class="whiteColor"><i class="fa fa-check-circle" style="color: #e4b248"></i><span class="bullet-point">Nordic Suite ₦{{$nordic->price}} / night</p>
							...
							<div>
								<div class="pull-left search-button clearfix">
									...
									<a href="{{url('/nsreservation')}}"><i class="fa fa-calendar"></i>BOOK NOW</a>
									@else
