			...
			<div class="row">
				...
				<div class="col-lg-9 clearfix"><!-- Room Information -->
					<div class="col-lg-8 clearfix col-sm-8">
						...
						<h6>RATES</h6>
						<p><i class="fa fa-check-circle" style="color: #e4b248"></i><span class="bullet-point">Executive Suite: ₦35,500</span></p>
					...
					<div class="quick-reservation-container">
						<div class="quick-reservation clearfix">
							<div class="title-quick pos-center margint30">
								...
								<div class="line"></div>
								<div>
									<h6 class="whiteColor">The Nordic Suite ₦35,500/night</h6>
								</div>
							</div>
