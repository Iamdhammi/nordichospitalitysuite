		...
		<div class="newsletter-section"><!-- Newsletter Section -->
			<div class="container">
				<div class="row">
					...
					<div class="newsletter-form margint40 marginb40 pos-center">
						<div class="newsletter-wrapper">
							...
							<div class="pull-left">
								<form action="{{url('/')}}" method="post">
									{{ csrf_field() }}
									<input type="email" name="email" placeholder="Enter a e-mail address">
									<input type="submit" value="SUBSCRIBE">
								</form>
							</div>
						</div>
						@if (\Session::has('success'))
						<div style="color: #e4b248;padding-top: 5px;">
