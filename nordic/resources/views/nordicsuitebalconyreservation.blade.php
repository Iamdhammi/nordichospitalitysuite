							...
							<ul class="clearfix">
								<div class="row">
									<div class="col-md-6">
										<li class="li-input li-side">
											...
											<input type="text" id="room" name="room_type" value="Nordic Suite Balcony" disabled/>
										</li>
									</div>
									<div class="col-md-6">
										<li class="li-input li-side">
											<label>Price Per Night(₦)</label>
											<input type="text" id="price" name="room_price" value="{{$nordicBalcony->price}}" disabled/>
										</li>
									</div>
								</div>
								<li class="li-input">
								...
								<li class="li-select mg-r20">
									...
									<select id="room_no" name="room_no" class="pretty-select" required>
										@for($i = 1; $i <= $nordicBalcony->no_rooms_available; $i++)
