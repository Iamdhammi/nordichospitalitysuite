                  ...
                  <tr class="table-products-list pos-center">
                    ...
                    <td class="title-table">
                      <div class="room-details-list clearfix">
                        <div class="pull-left">
                        <h5><a href="{{url('/rooms/deluxe')}}">Deluxe Room</a></h5>
                        </div>
                ...
                @if($no_deluxeBalcony > 0)
                  <tr class="table-products-list pos-center">
                    ...
                    <td class="title-table">
                      <div class="room-details-list clearfix">
                        <div class="pull-left">
                          <h5><a href="{{url('/rooms/deluxebalcony')}}">Deluxe Balcony</a></h5>
                        </div>
                        <div class="pull-left room-rating">
                          <ul>
                            <li><i class="fa fa-star"></i></li>
                ...
                @if($no_nordic > 0)
                  <tr class="table-products-list pos-center">
                    ...
                    <td class="title-table">
                      <div class="room-details-list clearfix">
                        <div class="pull-left">
                          <h5><a href="{{url('/rooms/nordicsuite')}}">Nordic Suite</a></h5>
                        </div>
                        <div class="pull-left room-rating">
                          <ul>
                            <li><i class="fa fa-star"></i></li>
                ...
                @if($no_nordicBalcony > 0)
                  <tr class="table-products-list pos-center">
                    ...
                    <td class="title-table">
                      <div class="room-details-list clearfix">
                        <div class="pull-left">
                          <h5><a href="{{url('/rooms/nordicsuitebalcony')}}">Nordic Suite Balcony</a></h5>
                        </div>
                        <div class="pull-left room-rating">
                          <ul>
                            <li><i class="fa fa-star"></i></li>
                ...
                @if($no_standard > 0)
                  <tr class="table-products-list pos-center">
                    ...
                    <td class="title-table">
                      <div class="room-details-list clearfix">
                        <div class="pull-left">
                          <h5><a href="{{url('/rooms/standard')}}">Standard Room</a></h5>
                        </div>
                        <div class="pull-left room-rating">
                          <ul>
                            <li><i class="fa fa-star"></i></li>
